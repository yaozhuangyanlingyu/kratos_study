...
func _Greeter_Login0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.Login(ctx, req.(*Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type GreeterHTTPClient interface {
	Login(ctx context.Context, req *Empty, opts ...http.CallOption) (rsp *LoginReply, err error)
...
func (c *GreeterHTTPClientImpl) Login(ctx context.Context, in *Empty, opts ...http.CallOption) (*LoginReply, error) {
	var out LoginReply
	pattern := "/login"
